          ...
          <div onClick={e=>e.stopPropagation()} style={{ width:"100%", maxWidth:500, borderRadius:32, boxShadow:"0 40px 120px rgba(0,0,0,0.18)", background:"rgba(255,255,255,0.95)", backdropFilter:"blur(40px)", WebkitBackdropFilter:"blur(40px)", display:"flex", flexDirection:"column", maxHeight:"90vh" }}>
            ...
            <div style={{ padding:"24px 28px", overflowY:"auto", flex:1 }}>
              ...
              <form onSubmit={handleAddPeople}>
                {[{ label:"Username", key:"username", type:"text", placeholder:"Enter username" },{ label:"Email", key:"email", type:"email", placeholder:"Enter email address" },{ label:"Password", key:"password", type:"password", placeholder:"Set a password" },{ label:"Phone Number", key:"phone", type:"tel", placeholder:"Enter phone number" },{ label:"Employee ID", key:"employeeId", type:"text", placeholder:"Enter employee ID" }].map(f => (
